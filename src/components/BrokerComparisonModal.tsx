            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 border border-slate-200">
              ...
              {brokerA.connected ? (
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#5338ec] hover:bg-[#4338ca] text-white text-xs font-bold rounded-lg transition-all shadow-xs"
                >
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 border border-slate-200">
              ...
              {brokerB.connected ? (
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#0b1c30] hover:bg-slate-800 text-white text-xs font-bold rounded-lg transition-all shadow-xs"
                >
