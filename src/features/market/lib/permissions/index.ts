...
export const can=(tier:Tier,feature:Feature,entitlements?:Partial<Record<Feature,boolean>>)=>entitlements?.[feature] ?? tierRank[tier]>=tierRank[featureTier[feature]];
